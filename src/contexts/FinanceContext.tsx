...
// Imports do Supabase comentados - usando mock por enquanto
// import {
//   getTransactions,
//   createTransaction,
...
export const FinanceProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  // Estados dos arrays principais (usando dados mock por enquanto)
  ...
  // Carregar dados do Supabase ao montar o componente (DESABILITADO - usando mock por enquanto)
  // useEffect(() => {
  ...
  // Funções CRUD - Transactions (usando mock por enquanto)
  ...
  // Funções CRUD - CreditCards (usando mock por enquanto)
  ...
  // Funções CRUD - BankAccounts (usando mock por enquanto)
  ...
  // Funções CRUD - FamilyMembers (usando mock por enquanto)
